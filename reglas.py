...
def elimina_ejemplos(ejemplos,reglas,clase):
    res = ejemplos.copy()
    ...
    for ejemplo in ejemplos:
        ...
        for regla in reglas:
            ...
            if  all([atomo[1] == ejemplo[atomo[0]] for atomo in regla ]) and ejemplo[-1] == clase: 
                res.remove(ejemplo) #eliminamos los ejemplos que cumplan toda la regla completa y la clase
                break
